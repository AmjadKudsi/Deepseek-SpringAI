...
public class StudentService {
    ...
    // Ensure the student exists and create a new session for them.
    ...
    public String askThinkingQuestion(String studentId, String sessionId, String question) {
        var sessions = studentSessions.get(studentId);
        if (sessions == null || !sessions.contains(sessionId)) {
            throw new IllegalArgumentException("Unknown session for student");
        }
        return tutoringService.askThinkingQuestion(sessionId, question);
    }    
